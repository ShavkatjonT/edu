...
const studentExport = async ({ exitGroup_id, newGroup_id, student_id, group_student_id, summa, newGroupStudent_id, req }) => {
    try {
        ...
        const text = `${studentOne.firstname + " " + studentOne.lastname}ni ${groupOld.name} guruhidan ${groupNew.name} guruhiga ko'chirildi.`;
